...
soil_image_classification_bp = Blueprint("soil_image_classification", __name__)

# Load the pre-trained model (VGG16)
model = load_model(os.path.join(os.getcwd(), "models", "vgg16_soil.h5"))
...
@soil_image_classification_bp.route("/predict", methods=["POST"])
